...
export class MyCourseService implements Resolve<any> {
  public MY_COURSE_LIST_URL = `${isDevMode() && env.baseUrl || envProd.baseUrl}athlete/course/reserve/list`;
  ...
  getMyCourses(): Promise<any> {
    ...
    return new Promise((resolve, reject) => {
      this.httpClient.post(this.MY_COURSE_LIST_URL, data)
