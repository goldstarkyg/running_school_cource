...
export class AthleteFormComponent implements OnInit {
    ...
    */
    ...
    get password() { return this.verticalStepperStep5.get('password'); }
    get password2() { return this.verticalStepperStep5.get('confirm'); }
    ...
    showSuccessMessage() {
        ...
        const dialogRef = this.dialog.open(ResultsComponent, {
            ...
            data: { title: 'Athlete( Register )', content: this.retResult },
        });
    ...
    onPasswordInput() {
        if (this.verticalStepperStep5.hasError('passwordMismatch'))
            this.password2.setErrors([{ 'passwordMismatch': true }]);
        else
            this.password2.setErrors(null);

        this.szPWD = this.verticalStepperStep5.get('password').value;
    }
    ...
    sendRegister() {
        ...
        this.model['password'] = this.szPWD;
        ...
        this.registerService.register_athlete(this.model).subscribe(
            (data: any) => {
                /** spinner ends */
                this.hideSpinner();

                // this.retResult = data['msg'];
                // this.retResult = 'Verification mail has been sent. Please confirm to activate your account.'
                // this.showSuccessMessage();
                ...
                if (retCode == '200') {
                    ...
                    //----------------------
                    this.localsessionService.saveVerifyEmail(this.model.email);
                    this.localsessionService.saveVerifyPassword(this.model.password);
                    //----------------------

                    // this.router.navigate(['/']);
                    this.localsessionService.saveLogicStage('athlete_registered');
