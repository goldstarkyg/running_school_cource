...
export class TrainerFormComponent implements OnInit {
    ...
    showSuccessMessage() {
        ...
        const dialogRef = this.dialog.open(ResultsComponent, {
            ...
            data: { title: 'Personal Trainer( Register )', content: this.retResult },
        });
    ...
    sendRegister() {
        ...
        this.registerService.register_personal(this.model).subscribe(
          (data: any) => {
            /** spinner ends */
            this.hideSpinner();
            ...
            if (retCode == '200') {
              ...
              this.localsessionService.saveLogicStage('personal_registered');
