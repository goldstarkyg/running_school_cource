...
export class TrainerListComponent implements OnInit {
    ...
    constructor(
        private _TrainerListService: TrainerListService,
    ...
    ngOnInit(): void {
        ...
        this.dataSource = new FilesDataSource(this._TrainerListService, this.paginator, this.sort);
...
export class FilesDataSource extends DataSource<any>
{
    ...
    constructor(
        ...
        this.filteredData = this._TrainerListService.trainers;
    }
    ...
    connect(): Observable<any[]> {
        const displayDataChanges = [
            this._TrainerListService.onTrainersChanged,
        ...
        return merge(...displayDataChanges)
            .pipe(
                map(() => {
                    let data = this._TrainerListService.trainers.slice();
