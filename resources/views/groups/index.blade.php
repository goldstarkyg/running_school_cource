        ...
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    ...
                    <a href="{{ route('groups.create') }}" class="btn btn-sm btn-default"><span class="glyphicon glyphicon-plus"></span> @lang('button.create')</a>
                    </div>
                </div>
                <br />
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('groups.edit', $role->id) }}">
                                            ...
                                            @if ($role->id !== 1)
                                                ...
                                                @else
                                                    <!-- <a href="{{ route('groups.confirm-delete', $role->id) }}" data-toggle="modal" data-target="#delete_confirm">
