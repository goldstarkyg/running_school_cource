                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title"> <i class="livicon" data-name="users" data-size="16" data-c="#fff" data-hc="#fff" data-loop="true"></i>
                            Editing Trainer : <p class="user_name_max">{!! $user->first_name!!} {!! $user->last_name!!}</p>
                        </h3>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                {!! Form::model($user, ['url' => URL::to('trainer/'. $user->id.''), 'method' => 'put', 'class' => 'form-horizontal','id'=>'commentForm', 'enctype'=>'multipart/form-data','files'=> true]) !!}
                                    {{ csrf_field() }}
                                    ...
                                    <div id="rootwizard" class="row" >
                                            ...
                                            <div class="row">
                                                ...
                                                <div>
                                                        ...
                                                        <!--line-->
                                                        <div class="col-sm-6 form-group {{ $errors->first('school_id', 'has-error') }}">
                                                            <label for="school_id" class="col-sm-3 control-label">Sschool</label>
                                                            <div class="col-sm-9">
                                                                <select name="school_id" id= "school_id" class="form-control">                                                                    
                                                                    @foreach($schools as $sc)
                                                                        @php
                                                                            $selected = "";
                                                                            if($user->school_id == $sc->id) $selected = "selected";
                                                                        @endphp
...
@section('footer_scripts')
    ...
    <script src="{{ asset('assets/js/pages/new/edittrainer.js') }}"></script>
    <script>
