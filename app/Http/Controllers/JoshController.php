    ...
    public function pages(Request $request) {
        ...
        if($user) {
            $role = \DB::table('role_users')
                        ...
                        ->first();
            if($role->role_id == '1') return view('backend_super');
            if($role->role_id == '2') return view('backend_school');
            if($role->role_id == '3' || $role->role_id == '4') return view('backend_person');
            if($role->role_id == '5') return view('backend_athlete');
        }
        return view('frontend');
    }
