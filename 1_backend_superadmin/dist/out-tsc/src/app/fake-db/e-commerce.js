var SchoolFakeDb = /** @class */ (function () {
    function SchoolFakeDb() {
    }
    // displayedColumns = ['ID', 'LOGO', 'SCHOOL_NAME', 'FIRST_NAME', 'LAST_NAME', 'EMAIL', 'STATUS', 'CREATE', 'ACTIONS'];
    SchoolFakeDb.schools = [
        {
            'id': '1',
            'logourl': 'assets/images/school/school_logo.jpg',
            'imageurl': 'assets/images/school/school_banner.jpg',
            'schoolname': 'International School of Florence',
            'reference_asd': 'This is where I am working now',
            'company_code': '03929394',
            'school_state': 'School State',
            'school_region': 'School Region',
            'school_province': 'School Province',
            'school_city': 'School City',
            'school_address': 'School Address',
            'school_postalcode': '203929329',
            'school_membership': 'ASIC',
            'user_image': 'assets/images/school/manager_logo.jpg',
            'firstname': 'Jhon',
            'lastname': 'Smith',
            'gender': 'Smith',
            'email': 'schooladmin1111@gmail.com',
            'dateofbirth': 'schooladmin1111@gmail.com',
            'phone': '+39 055 646 1007',
            'state': 'Manager State',
            'region': 'Manager Region',
            'province': 'Manager Province',
            'city': 'Manager City',
            'address': 'Manager Address',
            'postal_code': '39438843',
            'group': 'School Administrator',
            'vat_number': '9345893485',
            'fiscal_code': 'ERW39422098',
            'membership': 'EFSO',
            'bio': 'xzcvlklkjsdlkjlkjk',
            'upload_urls': ['http://sadlkjfdslkjsdfalkj', 'http://sadlkjfdslkjsdfalkj'],
            'download_urls': ['http://sadlkjfdslkjsdfalkj', 'http://sadlkjfdslkjsdfalkj'],
            'status': 'activated',
            'create': '2019-06-08'
        },
        {
    ...
    SchoolFakeDb.techmanager = [
        {
            'id': '1',
            'school_id': '1',
            'user_image': 'assets/images/school/technical_logo.jpg',
            'first_name': 'Mikle',
            'last_name': 'Jackson',
            'nationality': 'Italian',
            'gender': 'male',
            'email': 'techmanager@gmail.com',
            'dateofbirth': '1987-01-23',
            'birthplace': 'ITALY STATE1 REGION 2 PROVINCE',
            'mobile_phone': '+49429384883',
            'state': 'state of manager',
            'region': 'region of manager',
            'province': 'province of manager',
            'city': 'city of manager',
            'address': 'address of manager',
            'certified_type': 'certification 1',
            'postal_code': '2932932903290',
            'group': 'School Technical Manager',
            'vat_number': '3294923492',
            'fiscal_code': '394802343',
            'card_number': '09324803294',
            'membership': 'ASIC',
            'bio': 'I am a talent guy',
        },
        {
            'id': '2',
            'school_id': '2',
            ...
            'birthplace': 'ITALY STATE1 REGION 2 PROVINCE',
            'mobile_phone': '+49429384883',
            'state': 'state2 of manager',
            'region': 'region2 of manager',
            'province': 'province2 of manager',
            'city': 'city2 of manager',
            'address': 'address2 of manager',
            'certified_type': 'certification 2',
            'postal_code': '2932932903290',
            'group': 'School Technical Manager',
            'vat_number': '32946123123',
            'fiscal_code': '645645',
            'card_number': '09324803294',
            'membership': 'EFGF',
            'bio': 'I am woman',
        },
        {
            ...
            'email': 'techmanager@gmail.com',
            'dateofbirth': '1987-02-23',
            'birthplace': 'ITALY STATE1 REGION 3 PROVINCE',
            'mobile_phone': '+49429384883',
            'state': 'state3 of manager',
            'region': 'region3 of manager',
            'province': 'province3 of manager',
            'city': 'city3 of manager',
            'address': 'address3 of manager',
            'certified_type': 'certification 3',
            'postal_code': '2932932903290',
            'group': 'School Technical Manager',
            'vat_number': '32946123123',
            'fiscal_code': '645645',
        ...
        },
        {
            ...
            'birthplace': 'ITALY STATE1 REGION 2 PROVINCE',
            'mobile_phone': '+49429384883',
            'state': 'state4 of manager',
            'region': 'region4 of manager',
            'province': 'province4 of manager',
            'city': 'city4 of manager',
            'address': 'address4 of manager',
            'certified_type': 'certification 4',
            'postal_code': '2932932903290',
            'group': 'School Technical Manager',
            'vat_number': '32946123123',
            'fiscal_code': '645645',
        ...
        },
        {
            ...
            'email': 'techmanager@gmail.com',
            'dateofbirth': '1987-02-23',
            'birthplace': 'ITALY STATE1 REGION 6 PROVINCE',
            'mobile_phone': '+49429384883',
            'state': 'state6 of manager',
            'region': 'region6 of manager',
            'province': 'province6 of manager',
            'city': 'city6 of manager',
            'address': 'address6 of manager',
            'certified_type': 'certification 6',
            'postal_code': '2932932903290',
            'group': 'School Technical Manager',
            'vat_number': '32946123123',
            'fiscal_code': '645645',
    ...
    SchoolFakeDb.schools_add = [
        {
            ...
            'school_postalcode': '203929329',
            'school_membership': 'ASIC',
            'user_image': 'assets/images/school/school_logo.jpg',
            'firstname': 'Jhon',
            'lastname': 'Smith',
            'gender': 'Smith',
            'email': 'schooladmin1111@gmail.com',
