...
import { SchoolFakeDb } from 'app/fake-db/e-commerce';
...
var FakeDbService = /** @class */ (function () {
    ...
    FakeDbService.prototype.createDb = function () {
        return {
            ...
            // E-Commerce
            'school-lists': SchoolFakeDb.schools,
            'school-list-add': SchoolFakeDb.schools_add,
            'school-techmanager': SchoolFakeDb.techmanager,
            'e-commerce-orders': SchoolFakeDb.orders,
            // Academy
            ...
            // Contacts
            'trainers-list': ContactsFakeDb.trainers_list,
            'trainers-add': ContactsFakeDb.trainers_add,
            'school-name-list': ContactsFakeDb.schoolnames,
            // Contacts
