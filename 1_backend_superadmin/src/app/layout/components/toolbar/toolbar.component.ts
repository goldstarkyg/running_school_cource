...
{
    public LOGOUT_URL = `${isDevMode() && env.basePageUrl || envProd.basePageUrl}`;
    ...
    {
        this.myEmail = _localSession.retrieveVerifyEmail();
        // Set the defaults
    ...
    onClickLogout()
    {
        ...
        this.confirmDialogRef.afterClosed().subscribe(result => {
            if (result) {
                this._global.logOut().subscribe( (data: any) => { location.href = this.LOGOUT_URL; },error => {});
            }
