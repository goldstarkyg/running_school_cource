...
export class AnalyticsDashboardService implements Resolve<any>
{
    ...
    widgets : any = {
        ...
        widget6: {
            markers: [
                {
                    lat  : 41.90370080000001,
                    lng  : 12.496235200000001,
                    label: 'Jhon'
                },
                {
                    lat  : 41.90270080000001,
                    lng  : 12.486235200000001,
                    label: 'Karl'
                },
                {
                    lat  : 41.91270080000001,
                    lng  : 12.456235200000001,
                    label: 'Jim'
                },
                {
                    lat  : 41.91370080000001,
                    lng  : 12.454235200000001,
                    label: 'Trans'
                },
                {
                    lat  : 41.93370080000001,
                    lng  : 12.464235200000001,
                    label: 'Ming'
                },
                {
                    lat  : 41.91370080000001,
                ...
                {
                    lat  : 41.92370080000001,
                    lng  : 12.474235200000001,
                    label: 'Harris'
                }
            ],
            styles : [
    ...
    getWidgets(): Promise<any>
    {
        ...
        //         }, reject);
        // });
        return new Promise((resolve, reject) => { resolve(this.widgets);});
    }
}
