...
import { LMainCourseService } from './lcourse.service';
...
@Component({
  selector: 'level-course',
  templateUrl: './lcourse.component.html',
  styleUrls: ['./lcourse.component.scss'],
  animations: fuseAnimations
})

export class LMainCourseListComponent implements OnInit {
  model: any = {};
  // courseList: any = [];
  ...
  displayedColumns: string[] = ['id', 'course_name', 'levels', 'from_date', 'to_date', 'status', 'course_content', 'modify'];
  dataSource: any;
  ...
  */
  constructor(
    ...
    private _Service: LMainCourseService,
  ...
  editCourse(item): void {
    var url = '/levels/' + item.id + '/' + item.course_name;
