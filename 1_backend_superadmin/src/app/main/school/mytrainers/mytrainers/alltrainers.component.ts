...
export interface TrainerListElement {
  id: number;
  avatar: string;
  school: string;
  name: string;
...
@Component({
  selector: 'all-trainers',
  templateUrl: './alltrainers.component.html',
  styleUrls: ['./alltrainers.component.scss'],
  animations: fuseAnimations
})

export class AllTrainerListComponent implements OnInit {
  model: any = {};
  // courseList: any = [];

  displayedColumns: string[] = ['id', 'avatar', 'name', 'school', 'email', 'phone', 'address', 'date', 'courseview'];
  dataSource: any;
  ...
  */
  ...
  ngOnInit() {
    this._Service.onAllTrainersChanged
      ...
      .subscribe(data => {
        ...
        this.dataSource = new MatTableDataSource<TrainerListElement>(data);
